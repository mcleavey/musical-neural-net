...
def train(model, use_pretrain, epochs, bs):        
    ...
    if use_pretrain:
        ...
        learner.model.load_state_dict(torch.load(LOAD_MOD_PATH/model))   
        m.freeze_to(-1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model", help="Generator model in ./models/generator")
    ...
    train(args.model, args.pretrain, args.epochs, args.bs)        
